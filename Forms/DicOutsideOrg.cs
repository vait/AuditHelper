...
{
    public partial class DicOutsideOrg : Form
    {
        private int _selectedID = -1;

        private void LoadData()
        {
            itemsLB.DataSource = ApplicationMap.OutsideOrg.GetAll();
        }
        ...
        private bool DeleteData()
        {
            try
            {
                ApplicationMap.OutsideOrg.Delete(ApplicationMap.OutsideOrg[_selectedID]);
            }
            catch
            {
                return false;
        ...
        private void ShowEditForm()
        {
            ...
            EditDicOutsideOrg frm = new EditDicOutsideOrg();
